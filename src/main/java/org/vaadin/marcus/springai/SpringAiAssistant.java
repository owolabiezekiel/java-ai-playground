...
public class SpringAiAssistant {
  ...
  public SpringAiAssistant(
      StreamingChatClient chatClient, VectorStore vectorStore, ChatHistory chatHistory) {
  ...
  public Flux<String> chat(String chatId, String userMessageContent) {
    ...
    Message systemMessage =
        getSystemMessage(
            similarDocuments, this.chatHistory.getLastN(chatId, CHAT_HISTORY_WINDOW_SIZE));
